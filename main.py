...
def openproject():
    try:
        ...
        command_check = {
            "vsCode": lambda : var["vsCode"].set(1),
            "pyCharm": lambda : var["pyCharm"].set(1),
            "explorer": lambda : var["explorer"].set(1),
        }

        open_check = {
            "vsCode": Checkbutton(root, text="vsCode", font=font,
                command=command_check["vsCode"]),
            "pycharm": Checkbutton(root, text="pycharm", font=font,
                command=command_check["pyCharm"]),
            "explorer": Checkbutton(root, text="Проводник", font=font,
                command=command_check["explorer"])
        }
